...
const app = Vue.createApp({
    ...
    data() {
        return {
            ...
            waterLevels:[
                ...
                { id: 'warn-high', color: 'warning', label: 'Warning - High Water Levels',
                min: 71, max: 90 }, 
                { id: 'danger-high', color: 'danger', label: 'Danger - High Water  Levels!', 
                min: 91, max: 100 }
            ]
        };
    },
    ...
    methods: {
        activeStatusLevel(waterLevel) {
            return this.waterLevelValue >=waterLevel.min && this.waterLevelValue <= waterLevel.max
